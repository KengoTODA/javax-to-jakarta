...
public class ClassFileConverterTest {
	@Test
	public void test() throws IllegalClassFormatException, IOException, NoSuchMethodException, SecurityException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		MyClassLoader classLoader = new MyClassLoader();
		byte[] classData = Files.readAllBytes(
				Paths.get("build", "classes", "java", "test", "jp", "skypencil", "jakarta", "CallingJavax.class"));
		byte[] converted = new ClassFileConverter().transform(classLoader, "jp/skypencil/jakarta/CallingJavax", null,
				null, classData);
